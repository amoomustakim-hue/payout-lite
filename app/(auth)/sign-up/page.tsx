...
export default function SignUpPage() {
  return (
    <main className="mx-auto max-w-md px-5 py-16">
      ...
      <p className="mt-2 text-slate-600">Start with a business profile, then connect Nomba test credentials.</p>
      <form className="mt-8 grid gap-4 rounded-lg border border-[var(--border)] bg-white p-5">
        <input className="rounded-md border border-[var(--border)] px-4 py-3" placeholder="Full name" />
        ...
        <Link href="/onboarding" className="rounded-md bg-[var(--payout-blue)] px-4 py-3 text-center font-semibold text-white">
          Continue
        </Link>
      </form>
    </main>
