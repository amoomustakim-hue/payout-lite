    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-[var(--background)] px-5 py-16">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-white p-6 shadow-sm">
          <h1 className="mb-1 text-lg font-bold text-[var(--foreground)]">Create account</h1>
          ...
          <p className="mt-4 text-center text-xs text-[var(--muted)]">
            ...
            <Link href="/sign-in" className="font-semibold text-[var(--payout-blue)] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
